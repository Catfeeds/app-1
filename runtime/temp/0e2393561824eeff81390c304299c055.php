...
<div class="page-container">
    ...
    <div class="row cl">
    	...
    	<div class="col-xs-6 col-sm-6">
			...
			<input type="hidden" name="needpay" value="<?php echo $needpay; ?>">
			<input type="hidden" name="companyName" value="<?php echo $companyName; ?>">
			<input type="hidden" name="jianzhitype" value="<?php echo $jianzhitype; ?>">
			<input type="hidden" name="salaryUnit" value="<?php echo $salaryUnit; ?>">
			<input type="hidden" name="salaryMoney" value="<?php echo $salaryMoney; ?>">
			<input type="hidden" name="alaryH" value="<?php echo $alaryH; ?>">
			<input type="hidden" name="salaryMan" value="<?php echo $salaryMan; ?>">
			<input type="hidden" name="salaryDay" value="<?php echo $salaryDay; ?>">
			<input type="hidden" name="schoolAccount" value="<?php echo $schoolAccount; ?>">
			<div class="row cl pay-content">
				支付金额：<?php echo $needpay; ?>元
			</div>
