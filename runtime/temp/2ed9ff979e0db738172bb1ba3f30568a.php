	    		...
	    		<div class="mt-20 post">
	    			<div class="row cl">
	    				<div class="col-xs-6 col-sm-6">
				            ...
				            <div class="col-xs-7 col-sm-7">
				            	<input type="text" class="input-text " name="jianzhitype" placeholder="请填写预招岗位名称">
				            </div>
				        </div>
				        <div class="col-xs-6 col-sm-6">
				            <lable class="col-xs-4 col-sm-4 text-r"><span class="c-red">*</span>岗位薪资:</lable>
				            <div class="col-xs-7 col-sm-7">
				            	<input type="text" class="input-text jobpay f-l" name="salaryMoney" placeholder="岗位薪资" id="salarymoney" style="width:60%;">
				            	<div class="select-box f-l" style="width:40%;">
				            		<select name="salaryUnit" class="select f-l"  datatype="*" nullmsg="请选择工作时长" id="salaryunit">
	    			...
	    			<div class="row cl">
	    				<div class="col-xs-6 col-sm-6">
				            ...
				            <div class="col-xs-7 col-sm-7">
				            	<input type="text" class="input-text" name="salaryMan" placeholder="招聘人数" id="salaryman">
				            </div>
				        </div>
				        <div class="col-xs-6 col-sm-6">
				            ...
				            <div class="col-xs-7 col-sm-7">
					            <div class="select-box">
				                    <select name="salaryH" class="select"  datatype="*" nullmsg="请选择工作时长" id="salaryh">
	    			...
	    			<div class="row cl">
	    				<div class="col-xs-6 col-sm-6">
				            ...
				            <div class="col-xs-7 col-sm-7">
				            	<input type="text" class="input-text" placeholder="工作天数" name="salaryDay" datatype="*" nullmsg="请填写工作天数" id="salaryday">
				            </div>
	    				</div>
	    			</div>
	    			<!--<div class="row cl">
	    				<div class="col-xs-6 col-sm-6">
				            ...
				            <div class="col-xs-4 col-sm-4">
				            	<input type="text" class="input-text jobadd" name="number" readonly="readonly">
				            </div>
...
<script type="text/javascript">
	$(function(){
		...
		/*$('.add-post').click(function(){
			$('.allpost').append('<div class="mt-20 post"  title="点击任意处计算">	 <div class="row cl">	<div class="col-xs-6 col-sm-6">				<lable class="col-xs-5 col-sm-5 text-r"><span class="c-red">*</span>岗位名称:</lable>				<div class="col-xs-7 col-sm-7">				            	<input type="text" class="input-text " name="number" placeholder="请填写预招岗位名称">				</div>				</div>				<div class="col-xs-6 col-sm-6">				<lable class="col-xs-5 col-sm-5 text-r"><span class="c-red">*</span>岗位薪水:</lable>				<div class="col-xs-4 col-sm-4">				            	<input type="text" class="input-text jobpay" name="number">				</div>				<span class="lh-30">元</span>				</div>	    			</div>	    			<div class="row cl">	    				<div class="col-xs-6 col-sm-6">				<lable class="col-xs-5 col-sm-5 text-r"><span class="c-red">*</span>招聘人数:</lable>				<div class="col-xs-4 col-sm-4">				            	<input type="text" class="input-text jobpeople" name="number" >				</div>				<span class="lh-30">人</span>				</div>				<div class="col-xs-6 col-sm-6">				<lable class="col-xs-5 col-sm-5 text-r"><span class="c-red">*</span>用工时长:</lable>				<div class="col-xs-4 col-sm-4">				            	<input type="text" class="input-text jobtime" name="number">				</div>				<span class="lh-30">天 / 时</span>				</div>	    			</div>	    			<div class="row cl">	    				<div class="col-xs-6 col-sm-6">				<lable class="col-xs-5 col-sm-5 text-r f-16"><strong>合计:</strong></lable>				<div class="col-xs-4 col-sm-4">				            	<input type="text" class="input-text jobadd" name="number" readonly="readonly">				</div>				<span class="lh-30">元</span>				</div>				<div class="col-xs-6 col-sm-6">				        	<span class="btn btn-secondary radius remove-post"><i class="Hui-iconfont" style="font-size: 16px;">&#xe609;&nbsp;</i>删除岗位</span>				</div>				</div>	    		</div>')
		})*/
